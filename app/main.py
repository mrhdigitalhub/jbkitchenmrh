...
# FIX SYNC: cari templates di semua kemungkinan lokasi (lokal & Vercel)
templates = None
templates_candidates = [
    BASE_DIR / "templates",              # app/templates (ketika dari app/main.py)
    PROJECT_ROOT / "app" / "templates",  # root/app/templates
...
if templates is None:
    print(f"[WARN] Folder templates tidak ditemukan. Candidates: {templates_candidates}")

# FIX SYNC: static juga
for static_cand in [
    BASE_DIR / "static",
