...
DEFAULT_SUB = [
    {"code":"cir","label":"Cairan","type":"sub","parent":"cuc"},
    {"code":"lut","label":"Laut / Seafood","type":"sub","parent":"dgi"},
    {"code":"oss","label":"Olahan Susu","type":"sub","parent":"dgi"},
    {"code":"sap","label":"Sapi","type":"sub","parent":"dgi"},
    {"code":"tlr","label":"Telur / Unggas","type":"sub","parent":"dgi"},
    {"code":"ugs","label":"Unggas Potong","type":"sub","parent":"dgi"},
    {"code":"buh","label":"Buah","type":"sub","parent":"nbt"},
    {"code":"kcg","label":"Kacang & Bijian","type":"sub","parent":"nbt"},
    {"code":"rmp","label":"Rempah","type":"sub","parent":"nbt"},
    {"code":"srl","label":"Serealia / Beras","type":"sub","parent":"nbt"},
    {"code":"syr","label":"Sayuran","type":"sub","parent":"nbt"},
    {"code":"umb","label":"Umbi-umbian","type":"sub","parent":"nbt"},
    {"code":"bdr","label":"Bumbu Dasar","type":"sub","parent":"nbt"},
    {"code":"myk","label":"Minyak & Lemak","type":"sub","parent":"nbt"},
    {"code":"krt","label":"Kertas / Karton","type":"sub","parent":"pck"},
    {"code":"pls","label":"Plastik","type":"sub","parent":"pck"},
    {"code":"sdk","label":"Sendok / Saji / Alat","type":"sub","parent":"pck"},
    {"code":"mmm","label":"Minuman / Air","type":"sub","parent":"pik"},
    {"code":"ras","label":"Rasa / Saus","type":"sub","parent":"prs"},
    {"code":"ins","label":"Instant / Bumbu Instan","type":"sub","parent":"prs"},
    {"code":"tpg","label":"Mie Kering","type":"sub","parent":"raw"},
]
